...
execute as @a[tag=spec.tmp.owner,limit=1] unless score @s spec.dimension matches 1..3 run tellraw @s {"type":"translatable","translate":"startback.spec.wrong","fallback":"维度计分板出问题了","color":"red"}
